...
class PermissionsController extends AppController
{
    ...
    public function delete(string $permissionId)
    {
        ...
        if ($permission->deleted !== null) {
            $this->Flash->warning(
                __d('ecr_common', 'The {0} has already been deleted.', strtolower(__d('ecr_permissions', 'Permission')))
            );
        } else {
            ...
            $this->Flash->success(
                __d('ecr_common', 'The {0} has been deleted.', strtolower(__d('ecr_permissions', 'Permission')))
            );
        }
