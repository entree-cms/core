...
class PermissionPolicy implements BeforePolicyInterface
{
     ...
     * @param mixed $permission The permission to be operated
     * @param string $action The action
     * @return \Authorization\Policy\ResultInterface|bool|null
     */
    public function before(?IdentityInterface $user, mixed $permission, string $action): ResultInterface|bool|null
    {
        if (
            $user
